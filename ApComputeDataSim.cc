...
//        std::cout << "Building the ANS String Data[Ends]"<< std::endl;
    ...
    void setANSVector(){
        ...
        for(int k=0;k<enumSize;k++){
            ...
            // ansVector.push_back(1099886703552000);
            //, 131382799891200, 3170893824000, 38661097149675)
...
//        std::cout << "Reading the ANS Dataset[Ends::MEMOSET]"<< std::endl;
    ...
    void read5Divs(){
        ...
        for(int i=0;i<1;i++) {
            ...
            sleep(1); std::cout << "{"<< divs[i+1]<<","<<divs[i+2]<<"},{"<<divs[i+1]<<","<<divs[i+3]<<"}"<<",{" <<divs[i+1]<<","<<divs[i+4]<< "}"<<std::endl;
            ...
            sleep(1); std::cout <<",{"<< divs[i]<<","<<divs[i+2]<<","<<divs[i+3]<<"},{"<<divs[i]<<","<<divs[i+2]<<","<<divs[i+4]<<"}";
            std::cout <<",{"<< divs[i]<<","<<divs[i+1]<<","<<divs[i+3]<<"},{"<<divs[i+1]<<","<<divs[i+2]<<","<<divs[i+3]<<"},{"<<divs[i+1]<<","<<divs[i+2]<<","<<divs[i+4]<<"}";
            sleep(1); std::cout <<",{"<< divs[i+1]<<","<<divs[i+3]<<","<<divs[i+4]<<"},{"<<divs[i+2]<<","<<divs[i+3]<<","<<divs[i+4]<<"}"<<std::endl;
    ...
    void formInstr(){
        ...
        std::cout << "--------------------------------" << std::endl;
        sleep(1); std::cout << "(RDSC)  1               45n" << std::endl;
        std::cout << "(RDSC)  2               20n+5" << std::endl;
        std::cout << "(RDSC)  3               15n" << std::endl;
        sleep(1); std::cout << "(RDSC)  4               11n+1" << std::endl;
        std::cout << "(RDSC)  5               9n" << std::endl;
        std::cout << "(RDSC)  6               7n+3" << std::endl;
        sleep(1);  std::cout << "(RDSC)  7               6n+3" << std::endl;
        std::cout << "(RDSC)  8               5n+5" << std::endl;
        sleep(1);  std::cout << "(RDSC)  9               5n" << std::endl;
...
int main(int argc, char** argv) {
    ...
    std::cout << "(RDSC) Data is information that can be used in making calculations or decisions." << std::endl;
